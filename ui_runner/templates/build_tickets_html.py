...
/* nav */
.snav{position:sticky;top:0;z-index:200;background:rgba(5,5,15,.96);backdrop-filter:blur(16px);border-bottom:1px solid var(--border);padding:0 24px;display:flex;align-items:center;height:62px;gap:16px;}
.snav-brand{display:flex;align-items:center;gap:12px;text-decoration:none;flex-shrink:0;}
.snav-name{font-family:'Bebas Neue',sans-serif;font-size:22px;letter-spacing:.12em;color:var(--accent);}
.snav-name span{color:var(--cyan);}
.snav-links{display:flex;align-items:stretch;gap:0;list-style:none;flex:1;}
.snav-links a{display:flex;align-items:center;gap:6px;padding:0 14px;font-size:11px;letter-spacing:1.5px;text-transform:uppercase;color:var(--muted);text-decoration:none;border-bottom:2px solid transparent;transition:color .15s,border-color .15s;white-space:nowrap;}
...
.snav-live{font-size:9px;letter-spacing:1.5px;color:var(--green);display:flex;align-items:center;gap:5px;}
.snav-live::before{content:'';width:5px;height:5px;border-radius:50%;background:var(--green);animation:livePulse 2s infinite;}
...
<nav class="snav">
  ...
  <ul class="snav-links">
    ...
    <li><a href="combined_slate_latest.html" class="active">&#x1F4CB; Slate</a></li>
    <li><a href="tickets_latest.html">&#x1F39F; Tickets</a></li>
